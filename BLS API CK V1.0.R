...
my_start_year <- as.character("2017") # Just specifying to make these characters
...
my_series_id <- "SMS02112600000000001"

# Need to use this one for a signle series
payload <- paste0("{\"seriesid\":[\"", my_series_id, "\"],
...
# Convert list into JSON jsonlite::toJSON()
...
rm(url, my_payload, some_series, my_series_id, my_start_year, my_end_year)
